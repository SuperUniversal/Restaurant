...
SoDo.md                   # Directory catalog & analysis strategy
model_capabilities.yaml   # Model capability profiles (optional)

.agent/
├── workflows/            # Slash commands (/plan, /execute, etc.)
├── superpower-skills/    # Superpowers extension skills
└── rules/                # Behavioral safety rules (6 files)

.agents/
└── core-skills/          # Core Agent specializations (GSD standard)
